          ...
          {project.heavy.length === 0 ? (
            ...
            <section className="space-y-2">
                    ...
                    >
                      ...
                      {isOpen && info && info.usages.length === 0 && (
                        <p className="mt-2 pl-3 text-xs text-amber-400/80">
                          Aucune référence trouvée dans le code — asset
                          possiblement inutilisé (la conversion reste sans
                          risque pour le build).
                        </p>
                      )}
                    </div>
                  );
              ...
              {project.heavy.length > heavyVisible && (
                ...
                >
                  Afficher plus ({project.heavy.length - heavyVisible}{" "}
                  restantes)
                </button>
              )}
            </section>
